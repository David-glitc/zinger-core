...
- Publishing others’ private information (including keys, wallets, IPs) without explicit permission
...
Report incidents to the maintainers via a private channel (see [`SECURITY.md`](SECURITY.md)
